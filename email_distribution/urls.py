...
from email_distribution.views import EmailDistributionListView, EmailDistributionDetailView, \
    EmailDistributionCreateView, EmailDistributionUpdateView, EmailDistributionDeleteView, mailing_active, \
    MessageCreateView, MessageListView, MessageDetailView, MessageUpdateView, MessageDeleteView, ClientListView, \
    ClientDetailView, ClientCreateView, ClientUpdateView, ClientDeleteView, LogsListView, index
